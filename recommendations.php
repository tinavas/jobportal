...
<?php 
$q="select * from recommend,register_emp where recommend.ID=register_emp.ID and recommend.jobid='".$_GET['jobid']."' ORDER BY register_emp.expyear desc";
...
?>
	<div class="entry">
	<?php
	//echo "<img float='left' src='uploads/' . $row['picture'] . 'width='100' height='100'} />";
   //echo "<img src="uploads/' . $row['picture'] . '"width="100" height="100"alt="Profile Picture" class="avatar img-circle img-thumbnail" alt="avatar" />";?>
    <div style="float:left;">
	<?php echo $row['firstname'].'&nbsp;'.$row['lastname'].'<br/>'.$row['email'].'<br/>'.$row['phone'].'<br/>'.$row['degree'].'<br/>Experience : '.$row['expyear'].'years'.$row['expmonth'].'months';?>
