...
if (isset($_POST['submit_val3']) && $_FILES['userfile']['size'] > 0)
{
$dbc = mysql_connect(DB_HOST, DB_USER, DB_PASSWORD) or die(mysql_error());
mysql_select_db(DB_NAME);
...
<td width="80">Upload your CV :<input name="upload" type="submit" class="box" id="upload" name="upload" value=" Upload "></td>
</tr>
</table>
