...
<!-- Mirrored from yukon-admin.tzdthemes.com/html/pages-invoices.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 May 2015 11:39:06 GMT -->
<head>
		<meta charset="UTF-8">
		<title>Yukon Admin HTML v1.5 (pages-invoices)</title>
    ...
    <body class="side_menu_active side_menu_expanded">
                    ...
                    <ul>
                        ...
                        <li class="first_level">
                            ...
                            <ul>
                                ...
                                <li><a class="act_nav" href="pages-invoices.php">Invoices</a></li>
	    ...
	    <!-- page specific plugins -->
            ...
            <!-- qrcode -->
            <script src="assets/lib/jquery-qrcode-0.10.1/jquery.qrcode-0.10.1.php"></script>
