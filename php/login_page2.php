...
<!-- Mirrored from yukon-admin.tzdthemes.com/html/login_page2.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 May 2015 11:39:06 GMT -->
<head>
        <meta charset="UTF-8">
        <title>Yukon Admin Login Page 2</title>
        ...
        <div class="login_container">
            <form id="login_form" action="#" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" value="User" id="login_username" autocomplete="off">
                    </div>
                </div>
                <div class="form-group">
                    <label for="login_password" class="col-sm-3 control-label">Password</label>
                    <div class="col-sm-9">
                        <input type="password" class="form-control" value="password" id="login_password" autocomplete="off">
                    </div>
                </div>
