...
<!-- Mirrored from yukon-admin.tzdthemes.com/html/plugins-calendar.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 May 2015 11:40:12 GMT -->
<head>
		<meta charset="UTF-8">
		<title>Yukon Admin HTML v1.5 (plugins-calendar)</title>
        ...
        <div id="page_wrapper">
            ...
            <div id="main_wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading_a"><span class="heading_text">Basic</span></div>
                            <div id="calendar"></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading_a"><span class="heading_text">Phases of the Moon</span></div>
                            <div id="calendar_phases"></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <ul>
                        ...
                        <li class="first_level">
                            ...
                            <ul>
                                ...
                                <li><a class="act_nav" href="plugins-calendar.php">Calendar</a></li>
...
<!-- Mirrored from yukon-admin.tzdthemes.com/html/plugins-calendar.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 May 2015 11:40:18 GMT -->
</html>
