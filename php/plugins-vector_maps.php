...
<!-- Mirrored from yukon-admin.tzdthemes.com/html/plugins-vector_maps.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 May 2015 11:40:33 GMT -->
<head>
		<meta charset="UTF-8">
		<title>Yukon Admin HTML v1.5 (plugins-vector_maps)</title>
        ...
        <div id="page_wrapper">
            ...
            <div id="main_wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-7">
                            <div class="heading_a"><span class="heading_text">Markers on the world map</span></div>
                            <div id="vmap_markers" style="width:100%;height:300px"></div>
                        </div>
                        <div class="col-md-5">
                            <div class="heading_a"><button class="pull-right btn btn-default btn-xs" id="updateColors">Random</button><span class="heading_text">Random colors</span></div>
                            <div id="vmap_canada" style="width:100%;height:500px"></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <ul>
                        ...
                        <li class="first_level">
                            ...
                            <ul>
                                ...
                                <li><a class="act_nav" href="plugins-vector_maps.php">Vector Maps</a></li>
                            </ul>
                        </li>
...
<!-- Mirrored from yukon-admin.tzdthemes.com/html/plugins-vector_maps.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 May 2015 11:40:36 GMT -->
</html>
